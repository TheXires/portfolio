...
import styles from '../styles/general/imprint.module.css';
      ...
      <Layout>
        <div className={styles.innerContainer}>
          ...
          <p>
            ...
            <br />
            E-Mail: <a href="mailto:robin-beckmann@mailbox.org">robin-beckmann@mailbox.org</a>
            <br />
          </p>
          <p>
            <br />
          ...
          <br />
          Impressum (angepasst) vom <a href="https://www.impressum-generator.de">
            Impressum Generator
          </a> der{' '}
